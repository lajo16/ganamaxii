...
// Forzar operación "alquiler" si no viene en la URL
if (!isset($_GET['tipo_operacion']) || $_GET['tipo_operacion'] === '') {
  $_GET['tipo_operacion'] = 'alquiler';
}
?>
<section class="hero py-5">
  <div class="container">
    <div class="p-4 p-md-5 rounded-4 overlay">
      <h1 class="display-6 fw-semibold mb-1">Encuentra tu alquiler ideal en todo el Perú</h1>
      <div class="small text-secondary">
        🛡️️ Alquila con respaldo legal.
      </div>
  ...
  <div class="container">
    ...
    <div class="row g-4">
      <?php
        ...
        // Total según los filtros actuales (incluye tipo_operacion = alquiler)
        ...
        foreach($props as $p):
          ...
          $waText = "Hola, quiero preguntar por esta propiedad en alquiler:\n" .
                    ($p['titulo'] ?? ('ID ' . $p['id'])) . "\n" .
 ...
 <a class="btn btn-sm btn-ganamaxii px-4"
  ...
  Preguntar por esta propiedad
      ...
      <?php
        ...
        $qs = $_GET ?? [];
        unset($qs['page']);
        $self = basename($_SERVER['PHP_SELF']); // alquilar.php
