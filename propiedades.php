...
// Si quieres que tenga un default al entrar sin filtros, descomenta:
...
<section class="hero py-5">
  <div class="container">
    <div class="p-4 p-md-5 rounded-4 overlay">
      <h1 class="h4 mb-3">Propiedades</h1>
  ...
  <div class="container">
    ...
    <div class="row g-4">
      <?php
        ...
        if(!$props){
          echo '<div class="text-center text-muted py-5">No se encontraron propiedades con los filtros seleccionados.</div>';
        }
      ...
      <?php
        ...
        $qs = $_GET ?? [];
        unset($qs['page']);
        $base = 'propiedades.php' . (!empty($qs) ? ('?' . http_build_query($qs) . '&') : '?');
